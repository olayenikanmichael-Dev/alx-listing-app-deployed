...
<img src={property.image} alt={`${property.name} image`} className="w-full h-full object-cover" />
</div>
<div className="p-4">
...
<div className="text-sm text-yellow-600">⭐ {property.rating}</div>
</div>
</div>
...
<span key={c} className="px-2 py-0.5 border rounded text-gray-600">{c}</span>
))}
</div>
</div>
</article>
